...
%   cca: callosal cross-sectional area (mm^2)
    ...
    if isempty(g_cca)
        ...
        %[p_cca, g_cca] = allometric_regress(rib_table1_brainvol, rib_table1_ccarea);  % only has species summaries.
        [p_cca, g_cca, rsq] = allometric_regress(rib_fig1b_brain_volumes, rib_fig1b_ccas);
