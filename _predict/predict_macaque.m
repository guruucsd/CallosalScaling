...
[~,d_macaque,m_macaque,u_macaque,pmye_macaque] = predict_cc_fiber_distn(macaque_brain_wt);
f_fiber_distn = gcf;
...
cam_distn = rebin_distn(cam_figS5_data{1}(strcmp('macaque', cam_species),:), cam_figS5_xvals, cam_bins);
...
subplot(1,2,2);
hold on;
bh = bar(lam_bins, pmye_macaque*lam_distn, 1, 'g');
set(get(bh,'child'),'facea',.5)
ch = bar(cam_bins, pmye_macaque*cam_distn, 1, 'y');
