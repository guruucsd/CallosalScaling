...
% Process histogram from LaMantia & Rakic, 1990 (a & b)
    ...
    guru_assert(~isempty(xaxis_idx), 'Make sure x-axis indices were found.');
    guru_assert(~isempty(yaxis_idx), 'Make sure y-axis indices were found.');
