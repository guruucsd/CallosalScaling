...
hh_2010_datafile = fullfile(hh_2010_dir, 'hh_2010_data.mat');

if exist(hh_2010_datafile, 'file')% && false% true
    load(hh_2010_datafile);

else

    addpath(genpath(fullfile(hh_2010_dir,'..','_lib')));
