...
hh_2008_datafile = fullfile(hh_2008_dir, 'hh_2008_data.mat');

if exist(hh_2008_datafile, 'file')
    load(hh_2008_datafile);
    
else
    addpath(genpath(fullfile(hh_2008_dir,'..','_lib')));
