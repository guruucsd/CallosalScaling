ha_dir      = fileparts(which(mfilename));
ha_datafile = fullfile(ha_dir, 'ha_data.mat');


%% Figure 7
if exist(ha_datafile,'file')
    ...
    %        [d,xticks,yticks] = parse_img_by_color(fullfile(ha_dir, 'img', 'Fig7_marked.png'), 'g', @(x) (x), @(y) (0+10*y))
    img_file = fullfile(ha_dir, 'img', 'Fig7_marked.png');


    [d,pix,xticks,yticks] = parse_img_by_color(fullfile(ha_dir, 'img', 'Fig7_marked.png'), {'g' 'r'}, @(x) (nan(size(x))), @(y) (0+10*y))
